...
When the program is executed, it ask to input a prime number pr. If you enter a non-prime number, it will ask you to enter again until pr is a prime number.
...
Then the program will automatically do the encryption and decryption to return the value of the message that you enter.
